...
Use this skill when:
- Building type-safe AI agents with Python
- Creating structured outputs from LLMs using Pydantic models
- Implementing dependency injection for AI tools
- Working with PydanticAI agents, tools, or system prompts
- Building production-ready AI applications with validation
- Keywords: pydantic-ai, pydantic_ai, type-safe agent, structured output, dependency injection
