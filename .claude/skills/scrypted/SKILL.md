...
name: scrypted
description: >
  Scrypted home video integration platform management. Configure cameras, HomeKit Secure Video,
  Google Home, Alexa integration, NVR recording, and AI detection. Use when working with Scrypted,
  HKSV, smart camera integration, video streaming, or multi-platform camera bridges.
